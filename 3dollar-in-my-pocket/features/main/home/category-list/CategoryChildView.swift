...
class CategoryChildView: BaseView {
  ...
  let emptyLabel = UILabel().then {
    $0.text = "category_empty".localized
  ...
  override func layoutSubviews() {
    ...
    case .BUNGEOPPANG:
      ...
      self.setKerningText(text: "category_sub_text_bungeoppang".localized)
    case .GYERANPPANG:
