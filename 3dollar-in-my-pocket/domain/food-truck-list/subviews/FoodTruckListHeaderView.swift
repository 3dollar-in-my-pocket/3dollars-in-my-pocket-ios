...
final class FoodTruckListHeaderView: UICollectionReusableView {
    static let registerId = "\(FoodTruckListHeaderView.self)"
    ...
    private func bindConstraints() {
        ...
        self.adBannerView.snp.makeConstraints { make in
            make.left.equalToSuperview().offset(24)
            make.right.equalToSuperview().offset(-24)
            make.top.equalTo(self.orderFilterButton.snp.bottom).offset(19)
...
extension Reactive where Base: FoodTruckListHeaderView {
...
extension FoodTruckListHeaderView: GADBannerViewDelegate {
