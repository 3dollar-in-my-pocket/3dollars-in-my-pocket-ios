...
final class WriteDetailHeaderView: BaseCollectionViewReusableView {
    enum Layout {
    ...
    private func setOptionLabel() {
        ...
        optionLabel.font = Fonts.regular.font(size: 14)
    ...
    private func setMultiLabel() {
        ...
        multiSelectLabel.font = Fonts.bold.font(size: 12)
