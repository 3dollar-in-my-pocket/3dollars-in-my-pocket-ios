...
final class MainTabBarItemTests: XCTestCase {
    ...
    func test_TC1_탭이_홈_제보_커뮤니티_마이페이지_순서로_4개다() {
        // Given / When
    ...
    func test_TC1_모든탭이_비어있지않은_타이틀을_가진다() {
        // Given / When
    ...
    func test_TC1_탭순서가_TabBarTag_rawValue와_일치한다() {
        // Given / When
        let items = MainTabBarItem.all
